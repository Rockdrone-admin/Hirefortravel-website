...
export default function JobModal({ isOpen, job, onClose, onSave }) {
  ...
  return (
    <BaseModal
      ...
      title={job ? 'Edit Job Opening' : 'Add New Job Opening'}
      description={job ? 'Update the details for this position.' : 'Fill in the details to post a new position on the website.'}
      icon={<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-green-700"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"></rect><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"></path></svg>}
